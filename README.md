# DBeaver for Linux riscv64, Windows on Arm64 & FreeBSD
...
It also adds support to produce build artifacts for `Linux riscv64` and `FreeBSD aarch64/x86_64` platforms.
