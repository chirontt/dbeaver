...
%JAVA_HOME%/bin/javac -classpath ../../target/classes -h . -d ../../target/classes ../java/org/jkiss/wmi/service/WMIService.java
%JAVA_HOME%/bin/javac -classpath ../../target/classes -h . -d ../../target/classes ../java/org/jkiss/wmi/service/WMIObject.java
